...
public class EventService {
	...
	public LinkedHashMap<String, Object> findById(long id, boolean showAllDetails, boolean isRecurring) {
		
		EventInfoFactory eventInfoFactory = new EventInfoFactory();
		EventInfo eventInfo = eventInfoFactory.selectEvent(isRecurring);
		return eventInfo.getEventById(id, showAllDetails);
	}
